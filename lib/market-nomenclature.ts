...
// inglés, sin tilde, siglas IATA/ISO. El `name` se indexa solo, no hace falta
// repetirlo en los alias.
type CountryDef = { name: string; aliases: string[] };

export const COUNTRIES: CountryDef[] = [
  { name: "Argentina", aliases: ["ar", "arg"] },
  { name: "Aruba", aliases: ["aw", "abw"] },
  { name: "Bahamas", aliases: ["the bahamas", "bs", "bhs"] },
  { name: "Barbados", aliases: ["bb", "brb"] },
  { name: "Belice", aliases: ["belize", "bz", "blz"] },
  { name: "Bolivia", aliases: ["bo", "bol"] },
  { name: "Brasil", aliases: ["brazil", "br", "bra"] },
  { name: "Canadá", aliases: ["canada", "ca", "can"] },
  { name: "Chile", aliases: ["cl", "chl"] },
  { name: "Colombia", aliases: ["co", "col"] },
  { name: "Costa Rica", aliases: ["cr", "cri"] },
  { name: "Cuba", aliases: ["cu", "cub"] },
  { name: "Curazao", aliases: ["curacao", "curaçao", "cw", "cuw"] },
  { name: "Ecuador", aliases: ["ec", "ecu"] },
  { name: "El Salvador", aliases: ["salvador", "sv", "slv"] },
  {
    name: "Estados Unidos",
    aliases: [
  ...
  { name: "Guatemala", aliases: ["gt", "gtm"] },
  { name: "Guyana", aliases: ["gy", "guy"] },
  { name: "Haití", aliases: ["haiti", "ht", "hti"] },
  { name: "Honduras", aliases: ["hn", "hnd"] },
  { name: "Jamaica", aliases: ["jm", "jam"] },
  { name: "México", aliases: ["mexico", "mejico", "mx", "mex"] },
  { name: "Nicaragua", aliases: ["ni", "nic"] },
  { name: "Panamá", aliases: ["panama", "pa", "pan"] },
  { name: "Paraguay", aliases: ["py", "pry"] },
  { name: "Perú", aliases: ["peru", "pe", "per"] },
  { name: "Puerto Rico", aliases: ["pr", "pri"] },
  {
  ...
  { name: "Surinam", aliases: ["suriname", "sr", "sur"] },
  { name: "Trinidad y Tobago", aliases: ["trinidad and tobago", "trinidad & tobago", "trinidad", "tt", "tto"] },
  { name: "Uruguay", aliases: ["uy", "ury"] },
  { name: "Venezuela", aliases: ["ve", "ven"] },
];
...
export const CITIES: PlaceDef[] = [
  ...
  // ── Brasil ────────────────────────────────────────────────────────────────
  { name: "São Paulo", country: "Brasil", aliases: ["sao paulo", "san pablo", "gru", "sp"] },
  { name: "Río de Janeiro", country: "Brasil", aliases: ["rio de janeiro", "rio", "gig", "rj"] },
  ...
  { name: "Alabama", country: "Estados Unidos", aliases: ["al"], kind: "state" },
  { name: "Alaska", country: "Estados Unidos", aliases: ["ak"], kind: "state" },
  { name: "Arizona", country: "Estados Unidos", aliases: ["az"], kind: "state" },
  { name: "Arkansas", country: "Estados Unidos", aliases: ["ar"], kind: "state" },
  { name: "California", country: "Estados Unidos", aliases: ["ca"], kind: "state" },
  { name: "Colorado", country: "Estados Unidos", aliases: ["co"], kind: "state" },
  { name: "Connecticut", country: "Estados Unidos", aliases: ["ct"], kind: "state" },
  { name: "Delaware", country: "Estados Unidos", aliases: ["de"], kind: "state" },
  { name: "Florida", country: "Estados Unidos", aliases: ["fl"], kind: "state" },
  { name: "Georgia", country: "Estados Unidos", aliases: ["ga"], kind: "state" },
  { name: "Hawaii", country: "Estados Unidos", aliases: ["hawai", "hawái", "hi"], kind: "state" },
  { name: "Idaho", country: "Estados Unidos", aliases: ["id"], kind: "state" },
  { name: "Illinois", country: "Estados Unidos", aliases: ["il"], kind: "state" },
  { name: "Indiana", country: "Estados Unidos", aliases: ["in"], kind: "state" },
  { name: "Iowa", country: "Estados Unidos", aliases: ["ia"], kind: "state" },
  { name: "Kansas", country: "Estados Unidos", aliases: ["ks"], kind: "state" },
  { name: "Kentucky", country: "Estados Unidos", aliases: ["ky"], kind: "state" },
  { name: "Louisiana", country: "Estados Unidos", aliases: ["la", "luisiana"], kind: "state" },
  { name: "Maine", country: "Estados Unidos", aliases: ["me"], kind: "state" },
  { name: "Maryland", country: "Estados Unidos", aliases: ["md"], kind: "state" },
  { name: "Massachusetts", country: "Estados Unidos", aliases: ["ma"], kind: "state" },
  { name: "Michigan", country: "Estados Unidos", aliases: ["mi"], kind: "state" },
  { name: "Minnesota", country: "Estados Unidos", aliases: ["mn"], kind: "state" },
  { name: "Mississippi", country: "Estados Unidos", aliases: ["ms"], kind: "state" },
  { name: "Missouri", country: "Estados Unidos", aliases: ["mo"], kind: "state" },
  { name: "Montana", country: "Estados Unidos", aliases: ["mt"], kind: "state" },
  { name: "Nebraska", country: "Estados Unidos", aliases: ["ne"], kind: "state" },
  { name: "Nevada", country: "Estados Unidos", aliases: ["nv"], kind: "state" },
  { name: "New Hampshire", country: "Estados Unidos", aliases: ["nh", "nuevo hampshire"], kind: "state" },
  { name: "New Jersey", country: "Estados Unidos", aliases: ["nj", "nueva jersey"], kind: "state" },
  { name: "New Mexico", country: "Estados Unidos", aliases: ["nm", "nuevo mexico", "nuevo méxico"], kind: "state" },
  { name: "New York", country: "Estados Unidos", aliases: ["nueva york", "ny"], kind: "state" },
  { name: "North Carolina", country: "Estados Unidos", aliases: ["carolina del norte", "nc"], kind: "state" },
  { name: "North Dakota", country: "Estados Unidos", aliases: ["dakota del norte", "nd"], kind: "state" },
  { name: "Ohio", country: "Estados Unidos", aliases: ["oh"], kind: "state" },
  { name: "Oklahoma", country: "Estados Unidos", aliases: ["ok"], kind: "state" },
  { name: "Oregon", country: "Estados Unidos", aliases: ["or"], kind: "state" },
  { name: "Pennsylvania", country: "Estados Unidos", aliases: ["pa", "pensilvania"], kind: "state" },
  { name: "Rhode Island", country: "Estados Unidos", aliases: ["ri"], kind: "state" },
  { name: "South Carolina", country: "Estados Unidos", aliases: ["carolina del sur", "sc"], kind: "state" },
  { name: "South Dakota", country: "Estados Unidos", aliases: ["dakota del sur", "sd"], kind: "state" },
  { name: "Tennessee", country: "Estados Unidos", aliases: ["tn"], kind: "state" },
  { name: "Texas", country: "Estados Unidos", aliases: ["tx"], kind: "state" },
  { name: "Utah", country: "Estados Unidos", aliases: ["ut"], kind: "state" },
  { name: "Vermont", country: "Estados Unidos", aliases: ["vt"], kind: "state" },
  { name: "Virginia", country: "Estados Unidos", aliases: ["va", "virginia"], kind: "state" },
  { name: "Washington", country: "Estados Unidos", aliases: ["wa"], kind: "state" },
  { name: "West Virginia", country: "Estados Unidos", aliases: ["virginia occidental", "wv"], kind: "state" },
  { name: "Wisconsin", country: "Estados Unidos", aliases: ["wi"], kind: "state" },
  { name: "Wyoming", country: "Estados Unidos", aliases: ["wy"], kind: "state" },
  // ── Canadá ────────────────────────────────────────────────────────────────
...
export const REGIONS: RegionDef[] = [
  { name: "Centroamérica", aliases: ["centroamerica", "centro america", "central america", "cam", "ca"] },
