...
with
  ...
  place_alias(alias, place, country, ambiguous) as (values
    ...
    ('ak', 'Alaska', 'Estados Unidos', false),
    ('al', 'Alabama', 'Estados Unidos', false),
    ('alabama', 'Alabama', 'Estados Unidos', false),
    ('alaska', 'Alaska', 'Estados Unidos', false),
    ('ar', 'Arkansas', 'Estados Unidos', false),
    ...
    ('az', 'Arizona', 'Estados Unidos', false),
    ...
    ('ca', 'California', 'Estados Unidos', false),
    ...
    ('co', 'Colorado', 'Estados Unidos', false),
    ...
    ('ct', 'Connecticut', 'Estados Unidos', false),
    ...
    ('de', 'Delaware', 'Estados Unidos', false),
    ...
    ('fl', 'Florida', 'Estados Unidos', false),
    ...
    ('ga', 'Georgia', 'Estados Unidos', false),
    ...
    ('ks', 'Kansas', 'Estados Unidos', false),
    ('ky', 'Kentucky', 'Estados Unidos', false),
    ('la', 'Louisiana', 'Estados Unidos', false),
    ...
    ('ma', 'Massachusetts', 'Estados Unidos', false),
    ...
    ('md', 'Maryland', 'Estados Unidos', false),
    ('mde', 'Medellín', 'Colombia', false),
    ('mdz', 'Mendoza', 'Argentina', false),
    ('me', 'Maine', 'Estados Unidos', false),
    ...
    ('mi', 'Michigan', 'Estados Unidos', false),
    ...
    ('mn', 'Minnesota', 'Estados Unidos', false),
    ('mo', 'Missouri', 'Estados Unidos', false),
    ...
    ('ms', 'Mississippi', 'Estados Unidos', false),
    ('msy', 'Nueva Orleans', 'Estados Unidos', false),
    ('mt', 'Montana', 'Estados Unidos', false),
    ...
    ('nc', 'North Carolina', 'Estados Unidos', false),
    ('nd', 'North Dakota', 'Estados Unidos', false),
    ('ne', 'Nebraska', 'Estados Unidos', false),
    ...
    ('nh', 'New Hampshire', 'Estados Unidos', false),
    ('nj', 'New Jersey', 'Estados Unidos', false),
    ('nm', 'New Mexico', 'Estados Unidos', false),
    ...
    ('nv', 'Nevada', 'Estados Unidos', false),
    ('ny', 'New York', 'Estados Unidos', false),
    ('oh', 'Ohio', 'Estados Unidos', false),
    ('ohio', 'Ohio', 'Estados Unidos', false),
    ('ok', 'Oklahoma', 'Estados Unidos', false),
    ('oklahoma', 'Oklahoma', 'Estados Unidos', false),
    ('or', 'Oregon', 'Estados Unidos', false),
    ...
    ('pa', 'Pennsylvania', 'Estados Unidos', false),
    ...
    ('sc', 'South Carolina', 'Estados Unidos', false),
    ('scl', 'Santiago', 'Chile', true),
    ('sd', 'South Dakota', 'Estados Unidos', false),
    ...
    ('vt', 'Vermont', 'Estados Unidos', false),
    ('vvi', 'Santa Cruz de la Sierra', 'Bolivia', false),
    ('wa', 'Washington', 'Estados Unidos', false),
    ...
    ('wi', 'Wisconsin', 'Estados Unidos', false),
    ('willemstad', 'Willemstad', 'Curazao', false),
    ('wisconsin', 'Wisconsin', 'Estados Unidos', false),
    ('wv', 'West Virginia', 'Estados Unidos', false),
    ('wy', 'Wyoming', 'Estados Unidos', false),
  ...
  planned as (
    select r.*,
           case
             ...
             -- 2) el país entero
             when r.whole_country is not null then r.whole_country || ' (País)'
             -- 3) una plaza inequívoca, sin país delante
             when r.whole_place is not null
               then r.whole_place_country || ' - ' || r.whole_place
