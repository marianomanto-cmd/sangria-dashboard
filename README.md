...
app/
  ...
  api/
    plans/[planId]/
      export.xlsx/route.ts  # XLSX del plan (logo + firma + disclaimer legal)
      export.pdf/route.ts   # PDF del plan (logo + firma + disclaimer legal)
...
lib/
  ...
  brand-logo.ts             # carga el logo de marca (public/sangria-logo.png|jpg) para los exports PDF/XLSX
