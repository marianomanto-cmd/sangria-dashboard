...
db/
  ...
  felix-creative-1462.sql   # carga de UNA factura de creative de Félix (QuickBooks 1462, 02/sep/2026, FEL.c1003 Creative Fee 2026 Holiday, USD 21.150). **Aplicada en prod el 03/sep/2026** (verificación: 1 fila, chequeo OK); idempotente, con guard por slug y por N° ya tomado. Registro de una carga hecha a mano; el camino normal hoy es el panel "Cargar factura" de /creative
