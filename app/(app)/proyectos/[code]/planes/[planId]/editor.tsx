  ...
  const onMarkLive = async () => {
    if (
      !(await confirm({
        ...
        body: `El QA de la v${detail.plan.currentVersion} está cerrado y todos los ads están cargados. Marcar Live indica que la campaña está corriendo en las plataformas.`,
